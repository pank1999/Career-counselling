 ...
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="#contact" class="w3-bar-item w3-button w3-hide-small w3-hover-white"style="text-decoration:none;">Contact</a>
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      <a href="http://localhost/phplessons/hackathon-website/Dashboard01.php" class="w3-bar-item w3-button w3-hover-teal" style="background-color:;" style="text-decoration:none;">class 8-10</a>
      <a href="http://localhost/phplessons/hackathon-website/Dashboard01.php" class="w3-bar-item w3-button w3-hover-teal" style="background-color:"style="text-decoration:none;">class 11 & 12</a>
      <a href="http://localhost/phplessons/hackathon-website/Dashboard01.php" class="w3-bar-item w3-button w3-hover-teal" style="background-color:"style="text-decoration:none;">Graduation</a>
    </div>
  </div>

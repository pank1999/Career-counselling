...
<div class="w3-display-container w3-animate-opacity col-xs-12">
  <img src="http://localhost/phplessons/hackathon-website/image/bgimg3.jpg" alt="boat" style="width:100%;min-height:350px;max-height:400px;">
  <div class="w3-container w3-display-bottomleft w3-margin-bottom"> 
  <form method="get" style="margin-left:450px; " action="https://www.google.com/search">
       <input type="text"  style=" text-align:center; height:50px;" name="g" size="40" placeholder="search here" ><span class=""   style="size:50px;border:1px solid blcak; "></span>
      </form> 
      </div>
...
-->
  ...
  <div class="container">
    ...
    <h1 class="my-4" style="text-align:center; text-decoration:underline;">Phases during making career </h1>
-->
    <!-- Marketing Icons Section 
    <div class="row">
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Class 8-10</h4>
          <div class="card-body">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Class 11-12</h4>
          <div class="card-body">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <h4 class="card-header">Graduation</h4>
          <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <img class="img-fluid rounded" src="https://career-counselling.herokuapp.com/image/career-businessman-img.webp">
      </div>
    </div>

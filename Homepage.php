...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="https://career-counselling.herokuapp.com/Homepage.php" style="text-decoration:none;" class="w3-bar-item w3-button w3-teal"><i class="fa fa-home w3-margin-right"></i>Home</a>
  <a href="https://career-counselling.herokuapp.com/index.php" style="text-decoration:none;" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Career</a>
  <a href="https://career-counselling.herokuapp.com/expert.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white" style="text-decoration:none;">Advice</a>
  ...
  <?php
   ...
   ?>
    ...
    <a href="https://career-counselling.herokuapp.com/signup.php" style="text-decoration:none;"class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-white" title="signup"><span class="glyphicon glyphicon-user"></span>signup</a>
   ...
   <?php } ?>
    <?php 
      ...
      if(isset($_SESSION['email'])){ ?>
        <a href="https://career-counselling.herokuapp.com/logout.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" title="logout"><span class="glyphicon glyphicon-log-out"></span>logout</a>
      <?php } ?>
 </div>
 ...
 <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
  ...
  <?php 
    ...
    box-shadow: 0 9px rgb(94, 93, 91); ">
     ...
     <a href="https://career-counselling.herokuapp.com/Dashboard01.php"  style="text-decoration:none;">Get Started</a>
     </button>
      <?php } 
      else{ ?>
        <button class="button " style="margin-left:40%; margin-top:20px;
    ...
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-border w3-hover-shadow">
        ...
        <?php if((isset($_SESSION['email']))){?>
          <button   class="w3-button w3-teal w3-padding-large"> <i class=""></i> <a  href="https://career-counselling.herokuapp.com/Dashboard01.php" style="text-decoration:none;">Start</a></button>
        <?php } else{?>
          <button   class="w3-button w3-teal w3-padding-large"> <i class=""></i> <a  href="https://career-counselling.herokuapp.com/login.php" style="text-decoration:none;">Start</a></button>
        <?php }?> 
...
<div class="w3-card w3-white">
  <img src="https://career-counselling.herokuapp.com/image/slide1.jpg" alt="Snow" style="width:100% ;height:230px;">
...
<div class="w3-quarter">
<div class="w3-card w3-white">
  <img src="https://career-counselling.herokuapp.com/image/slide2.png" alt="Lights" style="width:100% ;height:230px;">
...
<div class="w3-quarter">
<div class="w3-card w3-white">
  <img src="https://career-counselling.herokuapp.com/image/slide3.png" alt="Mountains" style="width:100% ;height:230px;">
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-4">
        <?php if(!isset($_SESSION['email'])){ ?>
          ...
          <a class="btn btn-lg btn-success btn-block" href="https://career-counselling.herokuapp.com/signup.php">Get started</a>
      
        <?php } else{ ?>
          <a class="btn btn-lg btn-success btn-block" href="https://career-counselling.herokuapp.com/Dashboard01.php">Get started</a>
        <?php } ?>
